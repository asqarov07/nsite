            ...
            <div class="rd-navbar-inner-outer">
              <div class="rd-navbar-inner">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand Верхный регитстр -->
                  <div class="rd-navbar-brand"><a class="brand" href="index.html"><img class="brand-logo-dark" src="images/logotype2.jpg" alt="" width="198" height="66"/></a></div>
                </div>
 ...
 -->                      <li>
                ...
                <!-- <div class="rd-navbar-project">
                  <div class="rd-navbar-project-header">
                    <h5 class="rd-navbar-project-title">Галерея</h5>
      ...
      <section class="section swiper-container swiper-slider swiper-slider-2 swiper-slider-3" data-loop="true" data-autoplay="5000" data-simulate-touch="false" data-slide-effect="fade">
        <div class="swiper-wrapper text-sm-left">
          <div class="swiper-slide context-dark" data-slide-bg="images/qwer1.jpg">
          ...
          <div class="swiper-slide context-dark" data-slide-bg="images/qwer3.jpg">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row">
                  <div class="col-sm-9 col-md-8 col-lg-7 col-xl-7 offset-lg-1 offset-xxl-0">
          ...
          <div class="swiper-slide context-dark" data-slide-bg="images/qwer2.jpg">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row">
        ...
        <div class="container">
          <div class="owl-carousel owl-style-11 dots-style-2" data-items="1" data-sm-items="1" data-lg-items="2" data-xl-items="4" data-margin="30" data-dots="true" data-mouse-drag="true" data-rtl="true">
            <article class="box-icon-megan wow fadeInUp">
              ...
              <h5 class="box-icon-megan-title"><a href="#">Принимаем заказы</a></h5>
              <p class="box-icon-megan-text">Если хотите мы сами звоним вас. Просто заполняйте пункт "Заказать"</p>
            </article>
            <article class="box-icon-megan wow fadeInUp" data-wow-delay=".05s">
              <div class="box-icon-megan-header">
                <div class="box-icon-megan-icon linearicons-map2"></div>
              </div>
              <h5 class="box-icon-megan-title"><a href="#">Делаем ваш блюдо</a></h5>
              <p class="box-icon-megan-text">Ахмад Шеф Повор делает</p>
            </article>
            <article class="box-icon-megan wow fadeInUp" data-wow-delay=".1s">
              <div class="box-icon-megan-header">
                <div class="box-icon-megan-icon linearicons-radar"></div>
              </div>
              <h5 class="box-icon-megan-title"><a href="#">50 минут</a></h5>
              <p class="box-icon-megan-text">Доставка будет 30 - 50 минут.</p>
            </article>
            <article class="box-icon-megan wow fadeInUp" data-wow-delay=".15s">
              <div class="box-icon-megan-header">
                <div class="box-icon-megan-icon linearicons-thumbs-up"></div>
              </div>
              <h5 class="box-icon-megan-title"><a href="#">Оцените наш Likesushi</a></h5>
              <p class="box-icon-megan-text">Нам очень важно ваш ностроение и ваш отзыв.</p>
            </article>
          </div>
        </div>
      </section>
     ...
     <section class="section section-lg bg-default">
      ...
      <section class="section section-lg bg-default">
        <div class="container">
          <!-- <h3 class="oh-desktop"><span class="d-inline-block wow slideInUp">Наш Меню</span></h3> -->
          <br>
            <h5>Пиццы</h5> 
          <div class="row row-lg row-30">
            <div class="col-sm-6 col-lg-4 col-xl-3">                     
              <article class="product wow fadeInLeft" data-wow-delay=".15s">
                ...
                <h6 class="product-title">Гавайская</h6>
                <div class="product-price-wrap">
                  <div class="product-price">1490 тнг</div>
                </div>
                <!-- <div class="product-button">
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">              
              <article class="product wow fadeInLeft" data-wow-delay=".1s">
                ...
                <h6 class="product-title">Пицца Карл Маркс</h6>
                <div class="product-price-wrap">
                  <div class="product-price">1290 тнг</div>
                </div>
                <!-- <div class="product-button">
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">              
              <article class="product wow fadeInLeft" data-wow-delay=".05s">
                <div class="product-figure"><img src="images/3.jpg" alt="" width="161" height="162"/>
                </div>
                <div class="product-rating"><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span class="mdi mdi-star"></span><span class="mdi mdi-star text-gray-13"></span>
                </div>
                <h6 class="product-title">Пицца Пепперони</h6>
                <div class="product-price-wrap">
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">            
              <article class="product wow fadeInLeft" data-wow-delay=".15s">
                ...
                <h6 class="product-title">Кальцоне</h6>
                <div class="product-price-wrap">
                  <div class="product-price">1490 тнг</div>
                </div>
                <!-- <div class="product-button">
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">              
              <article class="product wow fadeInLeft" data-wow-delay=".1s">
                <div class="product-figure">
                  <img src="images/4.png" alt="" width="161" height="162"/>
                </div>
                <div class="product-rating">
                  <span class="mdi mdi-star"></span>
                  <span class="mdi mdi-star"></span>
                ...
                <h6 class="product-title">Капричиоза</h6>
                <div class="product-price-wrap">
                  <div class="product-price">1490 тнг</div>
                </div>
                <!-- <div class="product-button">
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">              
              <article class="product wow fadeInLeft" data-wow-delay=".05s">
                ...
                <h6 class="product-title">Четыре сыра</h6>
                <div class="product-price-wrap">
                  <div class="product-price product-price-old">1650 тнг</div>
                  <div class="product-price">1490 тнг</div>
                </div>
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3">              
              <article class="product wow fadeInLeft">
                ...
                <h6 class="product-title">Пицца Маргарито</h6>
                <div class="product-price-wrap">
                  <div class="product-price product-price-old">1650 тнг</div>
                  <div class="product-price">1490 тнг</div>
                </div>
      ...
      <section class="section section-sm section-first bg-default">
        <div class="container">
          ...
          <form class="rd-form rd-mailform form-style-1" data-form-output="form-output-global" data-form-type="contact" method="post" action="telega.php">
            <div class="row row-20 gutters-20">
              <div class="col-md-6 col-lg-4 oh-desktop">
                <div class="form-wrap wow slideInDown">
                  ...
                  <label class="form-label" for="contact-your-name-6">Имя*</label>
                </div>
              </div>
              <div class="col-md-6 col-lg-4 oh-desktop">
                <div class="form-wrap wow slideInUp">
                  <input class="form-input" id="contact-address-6" type="text" name="address" data-constraints="address">
                  <label class="form-label" for="contact-address-6">Адрес*</label>
                </div>
              </div>
              <div class="col-md-6 col-lg-4 oh-desktop">
                <div class="form-wrap wow slideInUp">
                  <input class="form-input" id="contact-phone-6" type="phone" name="phone" data-constraints="Введите номер телефона" required="Ваш Номер*">
                  <label class="form-label" for="contact-phone-6">Номер*</label>
                </div>
              </div>
            ...
            <div class="group-custom-1 group-middle oh-desktop">
              <button class="button button-lg button-primary button-winona wow fadeInRight" type="submit">Отправить</button>
              <!-- Quote Classic-->
              <article class="quote-classic quote-classic-3 wow slideInDown">
                <div class="quote-classic-text">
                  <p class="q">Закажи доставим бесплатно!</p>
                </div>
              </article>
            </div>
          </form>
      ...
      <!-- <section class="section section-md bg-default">
        <div class="container">
          <h3 class="oh-desktop">
            <span class="d-inline-block wow slideInDown">Наш Меню</span>
          </h3>
            ...
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInUp">
                  <div class="services-terri-figure"><img src="images/coffee.jpg" alt="" width="370" height="278"/>
                  </div>
                  <div class="services-terri-caption"><span class="services-terri-icon linearicons-coffee-cup"></span>
                    <h5 class="services-terri-title"><a href="#">Кофе</a></h5>
                  </div>
                </article>
              </div>
            </div>
              ...
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInDown">
                  ...
                  <div class="services-terri-caption"><span class="services-terri-icon linearicons-pizza"></span>
                    <h5 class="services-terri-title"><a href="#">Пиццa</a></h5>
                  </div>
                </article>
              </div>
            </div>
              ...
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInUp">
                  ...
                  <div class="services-terri-caption"><span class="services-terri-icon linearicons-hamburger"></span>
                    <h5 class="services-terri-title"><a href="#">Бургер</a></h5>
                  </div>
                </article>
              </div>
            </div>
              ...
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInDown">
                  ...
                  <div class="services-terri-caption"><span class="services-terri-icon linearicons-ice-cream"></span>
                    <h5 class="services-terri-title"><a href="#">Десерт</a></h5>
                  </div>
                </article>
              </div>
            </div>
            <div class="col-sm-6 col-lg-4">
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInUp">
                  ...
                  <div class="services-terri-caption"><span class="services-terri-icon linearicons-coffee-cup"></span>
                    <h5 class="services-terri-title"><a href="#">Компот</a></h5>
                  </div>
                </article>
              </div>
            </div>
              ...
              <div class="oh-desktop">
                ...
                <article class="services-terri wow slideInDown">
                  ...
                  <div class="services-terri-caption"><span class="services-terri-icon linearicons-steak"></span>
                    <h5 class="services-terri-title"><a href="#">Суши</a></h5>
                  </div>
                </article>
              </div>
            </div>
        ...
        <div class="container container-style-1">
          <div class="owl-carousel owl-style-12" data-items="1" data-sm-items="2" data-lg-items="3" data-margin="30" data-xl-margin="45" data-autoplay="true" data-nav="true" data-center="true" data-smart-speed="400">
            ...
            <article class="quote-tara">
              ...
              <div class="quote-tara-status">Клиент</div>
            </article>
            <!-- Quote Tara-->
            <article class="quote-tara">
              <div class="quote-tara-caption">
          ...
          <div class="row row-10 gutters-10 isotope" data-isotope-layout="masonry" data-isotope-group="gallery" data-lightgallery="group">
              ...
              <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInLeft">
                ...
                <div class="thumbnail-mary-caption">
                  <div>
                    ...
                    <div class="thumbnail-mary-location">Пицца</div>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-xs-6 col-sm-8 col-xl-4 isotope-item oh-desktop">
              ...
              <article class="thumbnail thumbnail-mary thumbnail-mary-big wow slideInRight"><a class="thumbnail-mary-figure" href="images/gallery-2-1200x800-original.jpg" data-lightgallery="item"><img src="images/gallery-2-631x587.jpg" alt="" width="631" height="587"/></a>
                <div class="thumbnail-mary-caption">
                  <div>
                    <h6 class="thumbnail-mary-title"><a href="#">Уютный интерьер</a></h6>
                    <div class="thumbnail-mary-location">Современный дизайн</div>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
              ...
              <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInDown"><a class="thumbnail-mary-figure" href="images/gallery-3-1200x800-original.jpg" data-lightgallery="item"><img src="images/gallery-3-311x289.jpg" alt="" width="311" height="289"/></a>
                <div class="thumbnail-mary-caption">
                  <div>
                    <h6 class="thumbnail-mary-title"><a href="#">От Шефа - Ахмед</a></h6>
                    <div class="thumbnail-mary-location">ТОП - Повар</div>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-xs-6 col-sm-8 col-xl-4 isotope-item oh-desktop">
              ...
              <article class="thumbnail thumbnail-mary wow slideInUp"><a class="thumbnail-mary-figure" href="images/gallery-4-1200x800-original.jpg" data-lightgallery="item"><img src="images/gallery-4-631x289.jpg" alt="" width="631" height="289"/></a>
                <div class="thumbnail-mary-caption">
                  <div>
                    <h6 class="thumbnail-mary-title"><a href="#">Освежающие коктейли</a></h6>
                    <div class="thumbnail-mary-location">Эксклюзивный выбор</div>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
              ...
              <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInUp"><a class="thumbnail-mary-figure" href="images/gallery-5-1200x800-original.jpg" data-lightgallery="item"><img src="images/gallery-5-311x289.jpg" alt="" width="311" height="289"/></a>
                <div class="thumbnail-mary-caption">
                  <div>
                    <h6 class="thumbnail-mary-title"><a href="#">Вкусный суши</a></h6>
                    <div class="thumbnail-mary-location">Летний Вкус</div>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
              ...
              <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInRight"><a class="thumbnail-mary-figure" href="images/gallery-6-1200x800-original.jpg" data-lightgallery="item"><img src="images/gallery-6-311x289.jpg" alt="" width="311" height="289"/></a>
                <div class="thumbnail-mary-caption">
                  <div>
                    <h6 class="thumbnail-mary-title"><a href="#">Все виды пиццы</a></h6>
                    <div class="thumbnail-mary-location">специальный рецепт</div>
                  </div>
                </div>
              </article>
            </div>
            <div class="col-xs-6 col-sm-4 col-xl-2 isotope-item oh-desktop">
              ...
              <article class="thumbnail thumbnail-mary thumbnail-mary-2 wow slideInLeft"><a class="thumbnail-mary-figure" href="images/gallery-7-1200x800-original.jpg" data-lightgallery="item"><img src="images/gallery-7-311x289.jpg" alt="" width="311" height="289"/></a>
                <div class="thumbnail-mary-caption">
                  <div>
                    <h6 class="thumbnail-mary-title"><a href="#">Меню</a></h6>
                    <div class="thumbnail-mary-location">Выбери свое любимое блюдо</div>
                  </div>
                </div>
              </article>
            </div>
      ...
      <!-- Bottom Banner<a class="section section-banner" href="https://www.templatemonster.com/intense-multipurpose-html-template.html" style="background-image: url(images/banner/background-03-1920x310.jpg); background-image: -webkit-image-set( url(images/banner/background-03-1920x310.jpg) 1x, url(images/banner/background-03-3840x620.jpg) 2x )">
        <img src="images/banner/foreground-03-1600x310.png" srcset="images/banner/foreground-03-1600x310.png 1x, images/banner/foreground-03-3200x620.png 2x" alt="" width="1600" height="310"></a>
       Page Footer-->
          ...
          <div class="container">
            <div class="row row-50">
              <div class="col-md-6 col-lg-4">
                <h5 class="footer-modern-title oh-desktop"><span class="d-inline-block wow slideInLeft">Что мы предлагаем</span></h5>
              ...
              <div class="col-md-6 col-lg-4 col-xl-3">
                <h5 class="footer-modern-title oh-desktop"><span class="d-inline-block wow slideInLeft">Информация</span></h5>
                <ul class="footer-modern-list d-inline-block d-sm-block wow fadeInUp">
                  <li><a href="about-us.html">О Нас</a></li>
                  <li><a href="#">Последние новости</a></li>
                  <li><a href="#">Наш Меню</a></li>
                  <li><a href="#">СМИ</a></li>
              ...
              <div class="col-lg-4 col-xl-5">
                <h5 class="footer-modern-title oh-desktop">
                  <span class="d-inline-block wow slideInLeft">Новостная рассылка</span>
                </h5>
                <p class="wow fadeInRight">Подпишитесь сегодня на последние новости и обновления.</p>
                RD Mailform-------------/>
                <form class="rd-form rd-mailform rd-form-inline rd-form-inline-sm oh-desktop" data-form-output="form-output-global" data-form-type="subscribe" method="post" action="bat/rd-mailform.php">
                  <div class="form-wrap wow slideInUp">
                    ...
                    <label class="form-label" for="subscribe-form-2-email">Введите ваш E-mail</label>
                  </div>
                  <div class="form-button form-button-2 wow slideInRight">
                    <button class="button button-sm button-icon-3 button-primary button-winona" type="submit"><span class="d-none d-xl-inline-block">Подписывайся</span><span class="icon mdi mdi-telegram d-xl-none"></span></button>
                  </div>
                </form>
              </div>
            </div>
                ...
                <div class="row row-30 align-items-center text-lg-center">
                  <div class="col-md-7 col-xl-6">
                    <a class="brand" href="index.html">
                      <img src="images/logotype1.jpg" alt="" width="106" height="46"/></a></div>
                  <!-- <div class="col-md-5 col-xl-6">
                    <div class="iso-1">
                      <span>
                        <img src="images/like-icon-58x25.png" alt="" width="58" height="25"/></span>
                        <span class="iso-1-big">23.4k</span>
                    </div>
                  </div> -->
                </div>
              </div>
                ...
                <div class="group-xmd group-sm-justify">
                  <div class="footer-modern-contacts wow slideInUp">
                    <div class="unit unit-spacing-sm align-items-center">
                      ...
                      <div class="unit-body"><a class="phone" href="tel:#">+7(775) 706 76 86</a></div>
                    </div>
                  </div>
        ...
        <div class="footer-modern-line-3">
          <div class="container">
            <div class="row row-10 justify-content-between">
              <div class="col-md-6"><span>Аксай 4-й микрорайон, 79а</span></div>
              <div class="col-md-auto">
                ...
                <p class="rights">
                  ...
                  <span>.&nbsp;</span>
                  <span>Разработано&nbsp;<a href="https://elsif.kz/">elsif Company</a></span>
                </p>
              </div>
            </div>
          </div>
